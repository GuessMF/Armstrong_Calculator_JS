...
calculate.addEventListener("click", () => {
  ...
  } else if (width.value > 50000 || height.value > 50000) {
    alert("Ведите число до 50000");
  } else {
...
function canvasDraw(width, height, line) {
  ...
  littleBlocksView.style.display = "flex";
